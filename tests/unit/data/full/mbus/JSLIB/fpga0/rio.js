...
module.exports = {
  ...
  set_tx: function (rio_tx) {
    data = Buffer.alloc(34, 0);
    RX_HEADER = Buffer.from("74697277", "hex").readInt32LE(0);
    VAROUT128_MBMASTER0_TXDATA = rio_tx["mbmaster0"]["txdata"];
    ...
    VAROUT1_FPGA0_WLED_1_GREEN = rio_tx["fpga0_wled"]["1_green"];
    VAROUT1_FPGA0_WLED_1_BLUE = rio_tx["fpga0_wled"]["1_blue"];
    VAROUT1_FPGA0_WLED_1_RED = rio_tx["fpga0_wled"]["1_red"];
    VAROUT1_FPGA0_WLED_2_GREEN = rio_tx["fpga0_wled"]["2_green"];
    VAROUT1_FPGA0_WLED_2_BLUE = rio_tx["fpga0_wled"]["2_blue"];
    VAROUT1_FPGA0_WLED_2_RED = rio_tx["fpga0_wled"]["2_red"];

    data.writeInt32LE(RX_HEADER, 0);
    if (VAROUT128_MBMASTER0_TXDATA) {
        data[4] |= (1<<7);
    }
  ...
  get_rx: function (data) {
    ...
    if ((data[11] & (1<<7)) != 0) {
        VARIN128_MBMASTER0_RXDATA = 1;
    } else {
        VARIN128_MBMASTER0_RXDATA = 0;
    }
