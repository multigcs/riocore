...
module rio (
        ...
        output wire PINOUT_FPGA0_W5500_MOSI,
        input wire PININ_FPGA0_W5500_MISO,
        output wire PINOUT_FPGA0_W5500_SCLK,
        output wire PINOUT_FPGA0_W5500_SEL,
        output wire PINOUT_FPGA0_WLED_DATA,
        output wire PINOUT_BLINK0_LED,
        inout wire PININOUT_I2CBUS0_SDA,
        output wire PINOUT_I2CBUS0_SCL,
        ...
        output wire PINOUT_STEPDIR2_EN,
        input wire PININ_BITIN0_BIT,
        input wire PININ_BITIN1_BIT,
        input wire PININ_BITIN2_BIT,
        input wire PININ_MBMASTER0_RX,
        output wire PINOUT_MBMASTER0_TX,
        output wire PINOUT_MBMASTER0_TX_ENABLE
    );
