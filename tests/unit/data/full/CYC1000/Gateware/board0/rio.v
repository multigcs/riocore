...
module rio (
        ...
        output wire PINOUT_PWMOUT0_PWM,
        output wire PINOUT_PWMOUT0_DIR,
        output wire PINOUT_PWMOUT0_EN,
    ...
    localparam TIMEOUT = 4800000;
    localparam TIMEOUT_BITS = 23;
    localparam BUFFER_SIZE_TX = 16'd104; // 13 bytes
    localparam BUFFER_SIZE_RX = 16'd104; // 13 bytes
