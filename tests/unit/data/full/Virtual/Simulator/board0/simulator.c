...
void simulation(void) {
    ...
    printf("> board0_wled.0_green %i\n", VAROUT1_BOARD0_WLED_0_GREEN);
    printf("> board0_wled.0_blue %i\n", VAROUT1_BOARD0_WLED_0_BLUE);
    printf("> board0_wled.0_red %i\n", VAROUT1_BOARD0_WLED_0_RED);
