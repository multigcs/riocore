...
void write_txbuffer(uint8_t *txBuffer) {
    ...
    txBuffer[16] |= (data->VAROUT1_BITOUT0_BIT<<7);  // 40
    txBuffer[16] |= (data->VAROUT1_STEPDIR0_ENABLE<<6);  // 39
    txBuffer[16] |= (data->VAROUT1_STEPDIR1_ENABLE<<5);  // 38
    txBuffer[16] |= (data->VAROUT1_STEPDIR2_ENABLE<<4);  // 37
    // FILL: 36
}
