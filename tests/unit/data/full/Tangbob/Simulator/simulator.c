...
void simulation(void) {
    ...
    printf("> wled0.1_green %i\n", VAROUT1_WLED0_1_GREEN);
    printf("> wled0.1_blue %i\n", VAROUT1_WLED0_1_BLUE);
    printf("> wled0.1_red %i\n", VAROUT1_WLED0_1_RED);
    printf("> wled0.2_green %i\n", VAROUT1_WLED0_2_GREEN);
    printf("> wled0.2_blue %i\n", VAROUT1_WLED0_2_BLUE);
    printf("> wled0.2_red %i\n", VAROUT1_WLED0_2_RED);
