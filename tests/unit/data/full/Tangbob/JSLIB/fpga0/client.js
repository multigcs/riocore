...
http.createServer(function (req, res) {
    ...
    if ("modbus0.txdata" in q.query) {
        rio.output["modbus0"]["txdata"] = parseInt(q.query["modbus0.txdata"]);
    }
    ...
    res.write("modbus0.txdata: <input type='text' id='modbus0.txdata' name='modbus0.txdata' value='" + String(rio.output["modbus0"]["txdata"]) + "'><br/>");
    ...
    res.write("modbus0.rxdata = ");
    res.write(String(rio_rx["modbus0"] ? rio_rx["modbus0"]["rxdata"] : "N/A"));
    res.write("<br/>");
