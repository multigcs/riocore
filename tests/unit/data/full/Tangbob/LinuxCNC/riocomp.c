...
typedef struct {
    ...
    hal_bit_t   *SIGOUT_WLED0_1_GREEN;
    hal_bit_t   *SIGOUT_WLED0_1_BLUE;
    hal_bit_t   *SIGOUT_WLED0_1_RED;
    hal_bit_t   *SIGOUT_WLED0_2_GREEN;
    hal_bit_t   *SIGOUT_WLED0_2_BLUE;
    hal_bit_t   *SIGOUT_WLED0_2_RED;
...
void register_signals(void) {
    ...
    *data->SIGOUT_WLED0_0_RED = 0;
    if (retval = hal_pin_bit_newf(HAL_IN, &(data->SIGOUT_WLED0_1_GREEN), comp_id, "%s.wled0.1_green", prefix) != 0) error_handler(retval);
    *data->SIGOUT_WLED0_1_GREEN = 0;
    if (retval = hal_pin_bit_newf(HAL_IN, &(data->SIGOUT_WLED0_1_BLUE), comp_id, "%s.wled0.1_blue", prefix) != 0) error_handler(retval);
    *data->SIGOUT_WLED0_1_BLUE = 0;
    if (retval = hal_pin_bit_newf(HAL_IN, &(data->SIGOUT_WLED0_1_RED), comp_id, "%s.wled0.1_red", prefix) != 0) error_handler(retval);
    *data->SIGOUT_WLED0_1_RED = 0;
    if (retval = hal_pin_bit_newf(HAL_IN, &(data->SIGOUT_WLED0_2_GREEN), comp_id, "%s.wled0.2_green", prefix) != 0) error_handler(retval);
    *data->SIGOUT_WLED0_2_GREEN = 0;
    if (retval = hal_pin_bit_newf(HAL_IN, &(data->SIGOUT_WLED0_2_BLUE), comp_id, "%s.wled0.2_blue", prefix) != 0) error_handler(retval);
    *data->SIGOUT_WLED0_2_BLUE = 0;
    if (retval = hal_pin_bit_newf(HAL_IN, &(data->SIGOUT_WLED0_2_RED), comp_id, "%s.wled0.2_red", prefix) != 0) error_handler(retval);
