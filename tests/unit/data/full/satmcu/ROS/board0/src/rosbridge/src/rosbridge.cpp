...
data_t *register_signals(void) {
    ...
    *data->SIGIN_BOARD0_BITIN6_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_BITIN7_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATUART0_TIMEOUT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_MPGESTOP_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_SCALE0_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_SCALE1_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_SCALE2_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_SELECTX_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_SELECTY_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_SELECTZ_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_CBUTTON_BIT_not = 1;
    ...
    *data->SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_not = 1;
...
void cb_SIGOUT_BOARD0_PWMOUT0_DTY(const std_msgs::Float32::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_PWMOUT0_DTY = msg->data;
}

void cb_SIGOUT_BOARD0_PWMOUT0_ENABLE(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_PWMOUT0_ENABLE = msg->data;
}

void cb_SIGOUT_BOARD0_BITOUT0_BIT(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_BITOUT0_BIT = msg->data;
}

void cb_SIGOUT_BOARD0_BITOUT1_BIT(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_BITOUT1_BIT = msg->data;
}

void cb_SIGOUT_BOARD0_SATMCU0_LEDSCALE0_BIT(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_SATMCU0_LEDSCALE0_BIT = msg->data;
}

void cb_SIGOUT_BOARD0_SATMCU0_LEDSCALE1_BIT(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_SATMCU0_LEDSCALE1_BIT = msg->data;
}

void cb_SIGOUT_BOARD0_SATMCU0_LEDSCALE2_BIT(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_SATMCU0_LEDSCALE2_BIT = msg->data;
}

void cb_SIGOUT_BOARD0_SATMCU0_SELECTEDX_BIT(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_SATMCU0_SELECTEDX_BIT = msg->data;
}

void cb_SIGOUT_BOARD0_SATMCU0_SELECTEDY_BIT(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_SATMCU0_SELECTEDY_BIT = msg->data;
}

void cb_SIGOUT_BOARD0_SATMCU0_SELECTEDZ_BIT(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BOARD0_SATMCU0_SELECTEDZ_BIT = msg->data;
}
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle nSIGIN_BOARD0_BITIN0_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_BITIN0_BIT;
    ros::Publisher pub_SIGIN_BOARD0_BITIN0_BIT = nSIGIN_BOARD0_BITIN0_BIT.advertise<std_msgs::Bool>("board0/board0/bitin0/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_BITIN1_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_BITIN1_BIT;
    ros::Publisher pub_SIGIN_BOARD0_BITIN1_BIT = nSIGIN_BOARD0_BITIN1_BIT.advertise<std_msgs::Bool>("board0/board0/bitin1/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_BITIN2_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_BITIN2_BIT;
    ros::Publisher pub_SIGIN_BOARD0_BITIN2_BIT = nSIGIN_BOARD0_BITIN2_BIT.advertise<std_msgs::Bool>("board0/board0/bitin2/bit", 1000);
    ...
    ros::NodeHandle nSIGIN_BOARD0_BITIN3_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_BITIN3_BIT;
    ros::Publisher pub_SIGIN_BOARD0_BITIN3_BIT = nSIGIN_BOARD0_BITIN3_BIT.advertise<std_msgs::Bool>("board0/board0/bitin3/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_BITIN4_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_BITIN4_BIT;
    ros::Publisher pub_SIGIN_BOARD0_BITIN4_BIT = nSIGIN_BOARD0_BITIN4_BIT.advertise<std_msgs::Bool>("board0/board0/bitin4/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_BITIN5_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_BITIN5_BIT;
    ros::Publisher pub_SIGIN_BOARD0_BITIN5_BIT = nSIGIN_BOARD0_BITIN5_BIT.advertise<std_msgs::Bool>("board0/board0/bitin5/bit", 1000);
    ros::NodeHandle nSIGOUT_BOARD0_PWMOUT0_DTY;
    ros::Subscriber sub_SIGOUT_BOARD0_PWMOUT0_DTY = nSIGOUT_BOARD0_PWMOUT0_DTY.subscribe("board0/board0/pwmout0/dty", 1000, cb_SIGOUT_BOARD0_PWMOUT0_DTY);
    ros::NodeHandle nSIGOUT_BOARD0_PWMOUT0_ENABLE;
    ros::Subscriber sub_SIGOUT_BOARD0_PWMOUT0_ENABLE = nSIGOUT_BOARD0_PWMOUT0_ENABLE.subscribe("board0/board0/pwmout0/enable", 1000, cb_SIGOUT_BOARD0_PWMOUT0_ENABLE);
    ros::NodeHandle nSIGOUT_BOARD0_BITOUT0_BIT;
    ros::Subscriber sub_SIGOUT_BOARD0_BITOUT0_BIT = nSIGOUT_BOARD0_BITOUT0_BIT.subscribe("board0/board0/bitout0/bit", 1000, cb_SIGOUT_BOARD0_BITOUT0_BIT);
    ros::NodeHandle nSIGOUT_BOARD0_BITOUT1_BIT;
    ros::Subscriber sub_SIGOUT_BOARD0_BITOUT1_BIT = nSIGOUT_BOARD0_BITOUT1_BIT.subscribe("board0/board0/bitout1/bit", 1000, cb_SIGOUT_BOARD0_BITOUT1_BIT);
    ros::NodeHandle nSIGIN_BOARD0_BITIN6_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_BITIN6_BIT;
    ros::Publisher pub_SIGIN_BOARD0_BITIN6_BIT = nSIGIN_BOARD0_BITIN6_BIT.advertise<std_msgs::Bool>("board0/board0/bitin6/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_BITIN7_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_BITIN7_BIT;
    ros::Publisher pub_SIGIN_BOARD0_BITIN7_BIT = nSIGIN_BOARD0_BITIN7_BIT.advertise<std_msgs::Bool>("board0/board0/bitin7/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_FEED_POSITION;
    std_msgs::Float32 msg_SIGIN_BOARD0_SATMCU0_FEED_POSITION;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_FEED_POSITION = nSIGIN_BOARD0_SATMCU0_FEED_POSITION.advertise<std_msgs::Float32>("board0/board0/satmcu0/feed/position", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATUART0_TIMEOUT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATUART0_TIMEOUT;
    ros::Publisher pub_SIGIN_BOARD0_SATUART0_TIMEOUT = nSIGIN_BOARD0_SATUART0_TIMEOUT.advertise<std_msgs::Bool>("board0/board0/satuart0/timeout", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_SPINDLE_POSITION;
    std_msgs::Float32 msg_SIGIN_BOARD0_SATMCU0_SPINDLE_POSITION;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_SPINDLE_POSITION = nSIGIN_BOARD0_SATMCU0_SPINDLE_POSITION.advertise<std_msgs::Float32>("board0/board0/satmcu0/spindle/position", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_RAPID_POSITION;
    std_msgs::Float32 msg_SIGIN_BOARD0_SATMCU0_RAPID_POSITION;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_RAPID_POSITION = nSIGIN_BOARD0_SATMCU0_RAPID_POSITION.advertise<std_msgs::Float32>("board0/board0/satmcu0/rapid/position", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_JOGWHEEL_POSITION;
    std_msgs::Float32 msg_SIGIN_BOARD0_SATMCU0_JOGWHEEL_POSITION;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_JOGWHEEL_POSITION = nSIGIN_BOARD0_SATMCU0_JOGWHEEL_POSITION.advertise<std_msgs::Float32>("board0/board0/satmcu0/jogwheel/position", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_MPGESTOP_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_MPGESTOP_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_MPGESTOP_BIT = nSIGIN_BOARD0_SATMCU0_MPGESTOP_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/mpgestop/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_SCALE0_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_SCALE0_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_SCALE0_BIT = nSIGIN_BOARD0_SATMCU0_SCALE0_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/scale0/bit", 1000);
    ros::NodeHandle nSIGOUT_BOARD0_SATMCU0_LEDSCALE0_BIT;
    ros::Subscriber sub_SIGOUT_BOARD0_SATMCU0_LEDSCALE0_BIT = nSIGOUT_BOARD0_SATMCU0_LEDSCALE0_BIT.subscribe("board0/board0/satmcu0/ledscale0/bit", 1000, cb_SIGOUT_BOARD0_SATMCU0_LEDSCALE0_BIT);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_SCALE1_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_SCALE1_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_SCALE1_BIT = nSIGIN_BOARD0_SATMCU0_SCALE1_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/scale1/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_SCALE2_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_SCALE2_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_SCALE2_BIT = nSIGIN_BOARD0_SATMCU0_SCALE2_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/scale2/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_SELECTX_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_SELECTX_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_SELECTX_BIT = nSIGIN_BOARD0_SATMCU0_SELECTX_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/selectx/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_SELECTY_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_SELECTY_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_SELECTY_BIT = nSIGIN_BOARD0_SATMCU0_SELECTY_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/selecty/bit", 1000);
    ros::NodeHandle nSIGOUT_BOARD0_SATMCU0_LEDSCALE1_BIT;
    ros::Subscriber sub_SIGOUT_BOARD0_SATMCU0_LEDSCALE1_BIT = nSIGOUT_BOARD0_SATMCU0_LEDSCALE1_BIT.subscribe("board0/board0/satmcu0/ledscale1/bit", 1000, cb_SIGOUT_BOARD0_SATMCU0_LEDSCALE1_BIT);
    ros::NodeHandle nSIGOUT_BOARD0_SATMCU0_LEDSCALE2_BIT;
    ros::Subscriber sub_SIGOUT_BOARD0_SATMCU0_LEDSCALE2_BIT = nSIGOUT_BOARD0_SATMCU0_LEDSCALE2_BIT.subscribe("board0/board0/satmcu0/ledscale2/bit", 1000, cb_SIGOUT_BOARD0_SATMCU0_LEDSCALE2_BIT);
    ros::NodeHandle nSIGOUT_BOARD0_SATMCU0_SELECTEDX_BIT;
    ros::Subscriber sub_SIGOUT_BOARD0_SATMCU0_SELECTEDX_BIT = nSIGOUT_BOARD0_SATMCU0_SELECTEDX_BIT.subscribe("board0/board0/satmcu0/selectedx/bit", 1000, cb_SIGOUT_BOARD0_SATMCU0_SELECTEDX_BIT);
    ros::NodeHandle nSIGOUT_BOARD0_SATMCU0_SELECTEDY_BIT;
    ros::Subscriber sub_SIGOUT_BOARD0_SATMCU0_SELECTEDY_BIT = nSIGOUT_BOARD0_SATMCU0_SELECTEDY_BIT.subscribe("board0/board0/satmcu0/selectedy/bit", 1000, cb_SIGOUT_BOARD0_SATMCU0_SELECTEDY_BIT);
    ros::NodeHandle nSIGOUT_BOARD0_SATMCU0_SELECTEDZ_BIT;
    ros::Subscriber sub_SIGOUT_BOARD0_SATMCU0_SELECTEDZ_BIT = nSIGOUT_BOARD0_SATMCU0_SELECTEDZ_BIT.subscribe("board0/board0/satmcu0/selectedz/bit", 1000, cb_SIGOUT_BOARD0_SATMCU0_SELECTEDZ_BIT);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_SELECTZ_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_SELECTZ_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_SELECTZ_BIT = nSIGIN_BOARD0_SATMCU0_SELECTZ_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/selectz/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_LBUTTON_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT = nSIGIN_BOARD0_SATMCU0_LBUTTON_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/lbutton/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_LBUTTON_BIT_SHORT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_SHORT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_SHORT = nSIGIN_BOARD0_SATMCU0_LBUTTON_BIT_SHORT.advertise<std_msgs::Bool>("board0/board0/satmcu0/lbutton/bit_short", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG1;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG1;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG1 = nSIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG1.advertise<std_msgs::Bool>("board0/board0/satmcu0/lbutton/bit_long1", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG2;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG2;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG2 = nSIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG2.advertise<std_msgs::Bool>("board0/board0/satmcu0/lbutton/bit_long2", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_CBUTTON_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_CBUTTON_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_CBUTTON_BIT = nSIGIN_BOARD0_SATMCU0_CBUTTON_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/cbutton/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_RBUTTON_BIT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT = nSIGIN_BOARD0_SATMCU0_RBUTTON_BIT.advertise<std_msgs::Bool>("board0/board0/satmcu0/rbutton/bit", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_RBUTTON_BIT_SHORT;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_SHORT;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_SHORT = nSIGIN_BOARD0_SATMCU0_RBUTTON_BIT_SHORT.advertise<std_msgs::Bool>("board0/board0/satmcu0/rbutton/bit_short", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG1;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG1;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG1 = nSIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG1.advertise<std_msgs::Bool>("board0/board0/satmcu0/rbutton/bit_long1", 1000);
    ros::NodeHandle nSIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG2;
    std_msgs::Bool msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG2;
    ros::Publisher pub_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG2 = nSIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG2.advertise<std_msgs::Bool>("board0/board0/satmcu0/rbutton/bit_long2", 1000);
    ...
    while (ros::ok()) {
        ...
        msg_SIGIN_BOARD0_BITIN0_BIT.data = *data->SIGIN_BOARD0_BITIN0_BIT;
        pub_SIGIN_BOARD0_BITIN0_BIT.publish(msg_SIGIN_BOARD0_BITIN0_BIT);

        msg_SIGIN_BOARD0_BITIN1_BIT.data = *data->SIGIN_BOARD0_BITIN1_BIT;
        pub_SIGIN_BOARD0_BITIN1_BIT.publish(msg_SIGIN_BOARD0_BITIN1_BIT);

        msg_SIGIN_BOARD0_BITIN2_BIT.data = *data->SIGIN_BOARD0_BITIN2_BIT;
        pub_SIGIN_BOARD0_BITIN2_BIT.publish(msg_SIGIN_BOARD0_BITIN2_BIT);
        ...
        msg_SIGIN_BOARD0_BITIN3_BIT.data = *data->SIGIN_BOARD0_BITIN3_BIT;
        pub_SIGIN_BOARD0_BITIN3_BIT.publish(msg_SIGIN_BOARD0_BITIN3_BIT);

        msg_SIGIN_BOARD0_BITIN4_BIT.data = *data->SIGIN_BOARD0_BITIN4_BIT;
        pub_SIGIN_BOARD0_BITIN4_BIT.publish(msg_SIGIN_BOARD0_BITIN4_BIT);

        msg_SIGIN_BOARD0_BITIN5_BIT.data = *data->SIGIN_BOARD0_BITIN5_BIT;
        pub_SIGIN_BOARD0_BITIN5_BIT.publish(msg_SIGIN_BOARD0_BITIN5_BIT);

        msg_SIGIN_BOARD0_BITIN6_BIT.data = *data->SIGIN_BOARD0_BITIN6_BIT;
        pub_SIGIN_BOARD0_BITIN6_BIT.publish(msg_SIGIN_BOARD0_BITIN6_BIT);

        msg_SIGIN_BOARD0_BITIN7_BIT.data = *data->SIGIN_BOARD0_BITIN7_BIT;
        pub_SIGIN_BOARD0_BITIN7_BIT.publish(msg_SIGIN_BOARD0_BITIN7_BIT);

        msg_SIGIN_BOARD0_SATMCU0_FEED_POSITION.data = *data->SIGIN_BOARD0_SATMCU0_FEED_POSITION;
        pub_SIGIN_BOARD0_SATMCU0_FEED_POSITION.publish(msg_SIGIN_BOARD0_SATMCU0_FEED_POSITION);

        msg_SIGIN_BOARD0_SATUART0_TIMEOUT.data = *data->SIGIN_BOARD0_SATUART0_TIMEOUT;
        pub_SIGIN_BOARD0_SATUART0_TIMEOUT.publish(msg_SIGIN_BOARD0_SATUART0_TIMEOUT);

        msg_SIGIN_BOARD0_SATMCU0_SPINDLE_POSITION.data = *data->SIGIN_BOARD0_SATMCU0_SPINDLE_POSITION;
        pub_SIGIN_BOARD0_SATMCU0_SPINDLE_POSITION.publish(msg_SIGIN_BOARD0_SATMCU0_SPINDLE_POSITION);

        msg_SIGIN_BOARD0_SATMCU0_RAPID_POSITION.data = *data->SIGIN_BOARD0_SATMCU0_RAPID_POSITION;
        pub_SIGIN_BOARD0_SATMCU0_RAPID_POSITION.publish(msg_SIGIN_BOARD0_SATMCU0_RAPID_POSITION);

        msg_SIGIN_BOARD0_SATMCU0_JOGWHEEL_POSITION.data = *data->SIGIN_BOARD0_SATMCU0_JOGWHEEL_POSITION;
        pub_SIGIN_BOARD0_SATMCU0_JOGWHEEL_POSITION.publish(msg_SIGIN_BOARD0_SATMCU0_JOGWHEEL_POSITION);

        msg_SIGIN_BOARD0_SATMCU0_MPGESTOP_BIT.data = *data->SIGIN_BOARD0_SATMCU0_MPGESTOP_BIT;
        pub_SIGIN_BOARD0_SATMCU0_MPGESTOP_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_MPGESTOP_BIT);

        msg_SIGIN_BOARD0_SATMCU0_SCALE0_BIT.data = *data->SIGIN_BOARD0_SATMCU0_SCALE0_BIT;
        pub_SIGIN_BOARD0_SATMCU0_SCALE0_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_SCALE0_BIT);

        msg_SIGIN_BOARD0_SATMCU0_SCALE1_BIT.data = *data->SIGIN_BOARD0_SATMCU0_SCALE1_BIT;
        pub_SIGIN_BOARD0_SATMCU0_SCALE1_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_SCALE1_BIT);

        msg_SIGIN_BOARD0_SATMCU0_SCALE2_BIT.data = *data->SIGIN_BOARD0_SATMCU0_SCALE2_BIT;
        pub_SIGIN_BOARD0_SATMCU0_SCALE2_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_SCALE2_BIT);

        msg_SIGIN_BOARD0_SATMCU0_SELECTX_BIT.data = *data->SIGIN_BOARD0_SATMCU0_SELECTX_BIT;
        pub_SIGIN_BOARD0_SATMCU0_SELECTX_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_SELECTX_BIT);

        msg_SIGIN_BOARD0_SATMCU0_SELECTY_BIT.data = *data->SIGIN_BOARD0_SATMCU0_SELECTY_BIT;
        pub_SIGIN_BOARD0_SATMCU0_SELECTY_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_SELECTY_BIT);

        msg_SIGIN_BOARD0_SATMCU0_SELECTZ_BIT.data = *data->SIGIN_BOARD0_SATMCU0_SELECTZ_BIT;
        pub_SIGIN_BOARD0_SATMCU0_SELECTZ_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_SELECTZ_BIT);

        msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT.data = *data->SIGIN_BOARD0_SATMCU0_LBUTTON_BIT;
        pub_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT);

        msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_SHORT.data = *data->SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_SHORT;
        pub_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_SHORT.publish(msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_SHORT);

        msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG1.data = *data->SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG1;
        pub_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG1.publish(msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG1);

        msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG2.data = *data->SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG2;
        pub_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG2.publish(msg_SIGIN_BOARD0_SATMCU0_LBUTTON_BIT_LONG2);

        msg_SIGIN_BOARD0_SATMCU0_CBUTTON_BIT.data = *data->SIGIN_BOARD0_SATMCU0_CBUTTON_BIT;
        pub_SIGIN_BOARD0_SATMCU0_CBUTTON_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_CBUTTON_BIT);

        msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT.data = *data->SIGIN_BOARD0_SATMCU0_RBUTTON_BIT;
        pub_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT.publish(msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT);

        msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_SHORT.data = *data->SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_SHORT;
        pub_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_SHORT.publish(msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_SHORT);

        msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG1.data = *data->SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG1;
        pub_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG1.publish(msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG1);

        msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG2.data = *data->SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG2;
        pub_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG2.publish(msg_SIGIN_BOARD0_SATMCU0_RBUTTON_BIT_LONG2);
