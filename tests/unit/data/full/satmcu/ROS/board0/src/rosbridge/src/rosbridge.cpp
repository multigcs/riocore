...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle nSIGIN_BOARD0_UARTSUB1_TIMEOUT;
    std_msgs::Bool msg_SIGIN_BOARD0_UARTSUB1_TIMEOUT;
    ros::Publisher pub_SIGIN_BOARD0_UARTSUB1_TIMEOUT = nSIGIN_BOARD0_UARTSUB1_TIMEOUT.advertise<std_msgs::Bool>("board0/board0/uartsub1/timeout", 1000);
    ...
    while (ros::ok()) {
        ...
        msg_SIGIN_BOARD0_UARTSUB1_TIMEOUT.data = *data->SIGIN_BOARD0_UARTSUB1_TIMEOUT;
        pub_SIGIN_BOARD0_UARTSUB1_TIMEOUT.publish(msg_SIGIN_BOARD0_UARTSUB1_TIMEOUT);
