...
typedef struct {
    ...
    hal_bit_t   *SIGIN_BOARD0_UARTSUB1_TIMEOUT;
    hal_bit_t   *SIGIN_BOARD0_UARTSUB1_TIMEOUT_not;
...
data_t *register_signals(void) {
    ...
    *data->SIGIN_BOARD0_BITIN5_BIT_not = 1 - *data->SIGIN_BOARD0_BITIN5_BIT;
    if ((retval = hal_pin_bit_newf(HAL_OUT, &(data->SIGIN_BOARD0_UARTSUB1_TIMEOUT), comp_id, "board0.uartsub1.timeout")) != 0) error_handler(retval);
    *data->SIGIN_BOARD0_UARTSUB1_TIMEOUT = 0;
    if ((retval = hal_pin_bit_newf(HAL_OUT, &(data->SIGIN_BOARD0_UARTSUB1_TIMEOUT_not), comp_id, "board0.uartsub1.timeout-not")) != 0) error_handler(retval);
