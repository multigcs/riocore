...
http.createServer(function (req, res) {
    ...
    res.write(String(rio_rx["bitin3"] ? rio_rx["bitin3"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("bitin4.bit = ");
    res.write(String(rio_rx["bitin4"] ? rio_rx["bitin4"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("bitin5.bit = ");
    res.write(String(rio_rx["bitin5"] ? rio_rx["bitin5"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("bitin6.bit = ");
    res.write(String(rio_rx["bitin6"] ? rio_rx["bitin6"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("bitin7.bit = ");
    res.write(String(rio_rx["bitin7"] ? rio_rx["bitin7"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("satuart0.timeout = ");
    res.write(String(rio_rx["satuart0"] ? rio_rx["satuart0"]["timeout"] : "N/A"));
    res.write("<br/>");
    res.write("mpgestop.bit = ");
    res.write(String(rio_rx["mpgestop"] ? rio_rx["mpgestop"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("scale0.bit = ");
    res.write(String(rio_rx["scale0"] ? rio_rx["scale0"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("scale1.bit = ");
    res.write(String(rio_rx["scale1"] ? rio_rx["scale1"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("scale2.bit = ");
    res.write(String(rio_rx["scale2"] ? rio_rx["scale2"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("selectx.bit = ");
    res.write(String(rio_rx["selectx"] ? rio_rx["selectx"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("selecty.bit = ");
    res.write(String(rio_rx["selecty"] ? rio_rx["selecty"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("selectz.bit = ");
    res.write(String(rio_rx["selectz"] ? rio_rx["selectz"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("lbutton.bit = ");
    res.write(String(rio_rx["lbutton"] ? rio_rx["lbutton"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("cbutton.bit = ");
    res.write(String(rio_rx["cbutton"] ? rio_rx["cbutton"]["bit"] : "N/A"));
    res.write("<br/>");
    res.write("rbutton.bit = ");
    res.write(String(rio_rx["rbutton"] ? rio_rx["rbutton"]["bit"] : "N/A"));
    res.write("<br/>");
