...
void write_txbuffer(uint8_t *txBuffer) {
    ...
    txBuffer[20] |= (VARIN1_BITIN2_BIT<<5); // 6
    txBuffer[20] |= (VARIN1_BITIN3_BIT<<4); // 5
    txBuffer[20] |= (VARIN1_BITIN4_BIT<<3); // 4
    txBuffer[20] |= (VARIN1_BITIN5_BIT<<2); // 3
