...
void cb_SIGOUT_BITOUT1_BIT(const std_msgs::Bool::ConstPtr& msg) {
    *data->SIGOUT_BITOUT1_BIT = msg->data;
}
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle nSIGOUT_BITOUT1_BIT;
    ros::Subscriber sub_SIGOUT_BITOUT1_BIT = nSIGOUT_BITOUT1_BIT.subscribe("/rio/bitout1/bit", 1000, cb_SIGOUT_BITOUT1_BIT);
    ...
    ros::NodeHandle nSIGIN_BITIN3_BIT;
    std_msgs::Bool msg_SIGIN_BITIN3_BIT;
    ros::Publisher pub_SIGIN_BITIN3_BIT = nSIGIN_BITIN3_BIT.advertise<std_msgs::Bool>("/rio/bitin3/bit", 1000);
    ros::NodeHandle nSIGIN_BITIN4_BIT;
    std_msgs::Bool msg_SIGIN_BITIN4_BIT;
    ros::Publisher pub_SIGIN_BITIN4_BIT = nSIGIN_BITIN4_BIT.advertise<std_msgs::Bool>("/rio/bitin4/bit", 1000);
    ros::NodeHandle nSIGIN_BITIN5_BIT;
    std_msgs::Bool msg_SIGIN_BITIN5_BIT;
    ros::Publisher pub_SIGIN_BITIN5_BIT = nSIGIN_BITIN5_BIT.advertise<std_msgs::Bool>("/rio/bitin5/bit", 1000);
    ...
    while (ros::ok()) {
        ...
        msg_SIGIN_BITIN3_BIT.data = *data->SIGIN_BITIN3_BIT;
        pub_SIGIN_BITIN3_BIT.publish(msg_SIGIN_BITIN3_BIT);

        msg_SIGIN_BITIN4_BIT.data = *data->SIGIN_BITIN4_BIT;
        pub_SIGIN_BITIN4_BIT.publish(msg_SIGIN_BITIN4_BIT);

        msg_SIGIN_BITIN5_BIT.data = *data->SIGIN_BITIN5_BIT;
        pub_SIGIN_BITIN5_BIT.publish(msg_SIGIN_BITIN5_BIT);
