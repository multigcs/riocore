...
typedef struct {
    ...
    bool   *SIGOUT_BITOUT1_BIT;
    bool   *SIGIN_BITIN1_BIT;
    bool   *SIGIN_BITIN1_BIT_not;
    bool   *SIGIN_BITIN2_BIT;
    bool   *SIGIN_BITIN2_BIT_not;
    bool   *SIGIN_BITIN3_BIT;
    bool   *SIGIN_BITIN3_BIT_not;
    bool   *SIGIN_BITIN4_BIT;
    bool   *SIGIN_BITIN4_BIT_not;
    bool   *SIGIN_BITIN5_BIT;
    bool   *SIGIN_BITIN5_BIT_not;
    // raw variables
...
void register_signals(void) {
    ...
    *data->SIGOUT_BITOUT0_BIT = 0;
    data->SIGOUT_BITOUT1_BIT = (bool*)malloc(sizeof(bool));
    ...
    *data->SIGIN_BITIN2_BIT_not = 1 - *data->SIGIN_BITIN2_BIT;
    data->SIGIN_BITIN3_BIT = (bool*)malloc(sizeof(bool));
    *data->SIGIN_BITIN3_BIT = 0;
    data->SIGIN_BITIN3_BIT_not = (bool*)malloc(sizeof(bool));
    *data->SIGIN_BITIN3_BIT_not = 1 - *data->SIGIN_BITIN3_BIT;
    data->SIGIN_BITIN4_BIT = (bool*)malloc(sizeof(bool));
    *data->SIGIN_BITIN4_BIT = 0;
    data->SIGIN_BITIN4_BIT_not = (bool*)malloc(sizeof(bool));
    *data->SIGIN_BITIN4_BIT_not = 1 - *data->SIGIN_BITIN4_BIT;
    data->SIGIN_BITIN5_BIT = (bool*)malloc(sizeof(bool));
    *data->SIGIN_BITIN5_BIT = 0;
    data->SIGIN_BITIN5_BIT_not = (bool*)malloc(sizeof(bool));
...
int msgarrvd(void *context, char *topicName, int topicLen, MQTTClient_message *message) {
    ...
    if (strlen(topicName) == 16 && strcmp(topicName, "/rio/bitout0/bit") == 0) {
        *data->SIGOUT_BITOUT0_BIT = atoi((char*)message->payload);
    }
    if (strlen(topicName) == 16 && strcmp(topicName, "/rio/bitout1/bit") == 0) {
        *data->SIGOUT_BITOUT1_BIT = atoi((char*)message->payload);
    }
...
int main(int argc, char **argv) {
    ...
    if ((rc = MQTTClient_subscribe(client, "/rio/bitout0/bit", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/bitout1/bit", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }
    ...
    while (1) {
        ...
        sprintf(tmp_str, "%i", *data->SIGIN_BITIN3_BIT);
        pubmsg.payload = tmp_str;
        pubmsg.payloadlen = (int)strlen(tmp_str);
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/bitin3/bit", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }

        sprintf(tmp_str, "%i", *data->SIGIN_BITIN4_BIT);
        pubmsg.payload = tmp_str;
        pubmsg.payloadlen = (int)strlen(tmp_str);
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/bitin4/bit", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }

        sprintf(tmp_str, "%i", *data->SIGIN_BITIN5_BIT);
        pubmsg.payload = tmp_str;
        pubmsg.payloadlen = (int)strlen(tmp_str);
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/bitin5/bit", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }
