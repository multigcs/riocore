...
int msgarrvd(void *context, char *topicName, int topicLen, MQTTClient_message *message) {
    if (strlen(topicName) == 35 && strcmp(topicName, "/rio/hm2_7c81/0/stepgen/02/velocity") == 0) {
        *data->SIGOUT_HM2_7C81_0_STEPGEN_02_VELOCITY = atof((char*)message->payload);
    }
    if (strlen(topicName) == 41 && strcmp(topicName, "/rio/hm2_7c81/0/stepgen/02/position_scale") == 0) {
        *data->SIGOUT_HM2_7C81_0_STEPGEN_02_POSITION_SCALE = atof((char*)message->payload);
    }
    if (strlen(topicName) == 35 && strcmp(topicName, "/rio/hm2_7c81/0/stepgen/01/velocity") == 0) {
        *data->SIGOUT_HM2_7C81_0_STEPGEN_01_VELOCITY = atof((char*)message->payload);
    }
    if (strlen(topicName) == 41 && strcmp(topicName, "/rio/hm2_7c81/0/stepgen/01/position_scale") == 0) {
        *data->SIGOUT_HM2_7C81_0_STEPGEN_01_POSITION_SCALE = atof((char*)message->payload);
    }
    if (strlen(topicName) == 35 && strcmp(topicName, "/rio/hm2_7c81/0/stepgen/00/velocity") == 0) {
        *data->SIGOUT_HM2_7C81_0_STEPGEN_00_VELOCITY = atof((char*)message->payload);
    }
    if (strlen(topicName) == 41 && strcmp(topicName, "/rio/hm2_7c81/0/stepgen/00/position_scale") == 0) {
        *data->SIGOUT_HM2_7C81_0_STEPGEN_00_POSITION_SCALE = atof((char*)message->payload);
    }
    if (strlen(topicName) == 28 && strcmp(topicName, "/rio/hm2_7c81/0/gpio/007/out") == 0) {
        *data->SIGOUT_HM2_7C81_0_GPIO_BIT = atoi((char*)message->payload);
    }
    if (strlen(topicName) == 31 && strcmp(topicName, "/rio/hm2_7c81/0/pwmgen/00/value") == 0) {
        *data->SIGOUT_HM2_7C81_0_PWMGEN_00_VALUE = atof((char*)message->payload);
    }
    if (strlen(topicName) == 32 && strcmp(topicName, "/rio/hm2_7c81/0/pwmgen/00/enable") == 0) {
        *data->SIGOUT_HM2_7C81_0_PWMGEN_00_ENABLE = atoi((char*)message->payload);
    }
    ...
    if (strlen(topicName) == 34 && strcmp(topicName, "/rio/lcec/0/ethercat1/position_cmd") == 0) {
        *data->SIGOUT_LCEC_0_ETHERCAT1_POSITION_CMD = atof((char*)message->payload);
    }
    if (strlen(topicName) == 36 && strcmp(topicName, "/rio/lcec/0/ethercat1/position_scale") == 0) {
        *data->SIGOUT_LCEC_0_ETHERCAT1_POSITION_SCALE = atof((char*)message->payload);
    }
...
int main(int argc, char **argv) {
    ...
    if ((rc = MQTTClient_subscribe(client, "/rio/hm2_7c81/0/stepgen/02/velocity", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/hm2_7c81/0/stepgen/02/position_scale", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/hm2_7c81/0/stepgen/01/velocity", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/hm2_7c81/0/stepgen/01/position_scale", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/hm2_7c81/0/stepgen/00/velocity", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/hm2_7c81/0/stepgen/00/position_scale", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/hm2_7c81/0/gpio/007/out", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/hm2_7c81/0/pwmgen/00/value", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/hm2_7c81/0/pwmgen/00/enable", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }
    ...
    if ((rc = MQTTClient_subscribe(client, "/rio/lcec/0/ethercat1/position_cmd", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }

    if ((rc = MQTTClient_subscribe(client, "/rio/lcec/0/ethercat1/position_scale", 0)) != MQTTCLIENT_SUCCESS) {
    	printf("Failed to subscribe, return code %d\n", rc);
    	rc = EXIT_FAILURE;
    }
    ...
    while (1) {
        ...
        sprintf(tmp_str, "%f", *data->SIGIN_HM2_7C81_0_STEPGEN_02_POSITION);
        pubmsg.payload = tmp_str;
        pubmsg.payloadlen = (int)strlen(tmp_str);
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/hm2_7c81/0/stepgen/02/position", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }

        sprintf(tmp_str, "%f", *data->SIGIN_HM2_7C81_0_STEPGEN_01_POSITION);
        pubmsg.payload = tmp_str;
        pubmsg.payloadlen = (int)strlen(tmp_str);
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/hm2_7c81/0/stepgen/01/position", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }

        sprintf(tmp_str, "%f", *data->SIGIN_HM2_7C81_0_STEPGEN_00_POSITION);
        pubmsg.payload = tmp_str;
        pubmsg.payloadlen = (int)strlen(tmp_str);
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/hm2_7c81/0/stepgen/00/position", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }

        sprintf(tmp_str, "%i", *data->SIGIN_HM2_7C81_0_GPIO_BIT);
        pubmsg.payload = tmp_str;
        pubmsg.payloadlen = (int)strlen(tmp_str);
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/hm2_7c81/0/gpio/015/in", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }
        ...
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/hm2_7c81/0/gpio/014/in", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }
        ...
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/hm2_7c81/0/gpio/013/in_not", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }
        ...
        sprintf(tmp_str, "%f", *data->SIGIN_LCEC_0_ETHERCAT1_POSITION_FB);
        pubmsg.payload = tmp_str;
        pubmsg.payloadlen = (int)strlen(tmp_str);
        pubmsg.qos = 0;
        pubmsg.retained = 0;
        if ((rc = MQTTClient_publishMessage(client, "/rio/lcec/0/ethercat1/position_fb", &pubmsg, &token)) != MQTTCLIENT_SUCCESS) {
             printf("Failed to publish message, return code %d\n", rc);
             exit(EXIT_FAILURE);
        }
