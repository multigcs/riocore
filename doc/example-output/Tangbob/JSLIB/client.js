...
server.on('message', (msg, rinfo) => {
    ...
    console.log("stepdir3.position = ", rio_rx["stepdir3"]["position"]);
    console.log("bitin0.bit = ", rio_rx["bitin0"]["bit"]);
    console.log("bitin1.bit = ", rio_rx["bitin1"]["bit"]);
    console.log("bitin2.bit = ", rio_rx["bitin2"]["bit"]);
    console.log("bitin3.bit = ", rio_rx["bitin3"]["bit"]);
    console.log("bitin4.bit = ", rio_rx["bitin4"]["bit"]);
});
...
function send() {
    ...
    rio.output["stepdir3"]["velocity"] = 0;
    rio.output["stepdir3"]["enable"] = 0;
