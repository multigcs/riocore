...
class Toolchain:
    ...
    def generate(self, path):
        ...
        if self.armcore:
            ...
            tcl_data.append("################################")
            tcl_data.append("")
            tcl_data.append("create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_0")
            tcl_data.append("set_property CONFIG.C_GPIO_WIDTH {4} [get_bd_cells axi_gpio_0]")
            tcl_data.append("apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system7_0/M_AXI_GP0} Slave {/axi_gpio_0/S_AXI} ddr_seg {Auto} intc_ip {New AXI SmartConnect} master_apm {0}}  [get_bd_intf_pins axi_gpio_0/S_AXI]")
            tcl_data.append("# apply_bd_automation -rule xilinx.com:bd_rule:board -config { Manual_Source {Auto}}  [get_bd_intf_pins axi_gpio_0/GPIO]")
            tcl_data.append("")
