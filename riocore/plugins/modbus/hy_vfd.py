...
class hy_vfd:
    ...
    def frameio_rx_c(self):
        ...
        output.append(
            f"                value_{self.signal_name}_speed_fb = value_{self.signal_name}_frq_get / value_{self.signal_name}_max_freq * value_{self.signal_name}_rev * {self.HYVFD_CALC_KEYS['speed_fb']['scale']};"
        )
        output.append("            }")
