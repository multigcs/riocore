...
class Plugin(PluginBase):
    ...
    def setup(self):
        self.NAME = "arty_mii"
        self.VERILOGS = ["sync_signal.v", "ssio_sdr_in.v", "mii_phy_if.v", "eth_mac_mii_fifo.v", "eth_mac_mii.v", "eth_mac_1g.v", "axis_gmii_rx.v", "axis_gmii_tx.v", "lfsr.v", "eth_axis_rx.v", "eth_axis_tx.v", "udp_complete.v", "udp_checksum_gen.v", "udp.v", "udp_ip_rx.v", "udp_ip_tx.v", "ip_complete.v", "ip.v", "ip_eth_rx.v", "ip_eth_tx.v", "ip_arb_mux.v", "arp.v", "arp_cache.v", "arp_eth_rx.v", "arp_eth_tx.v", "eth_arb_mux.v", "arbiter.v", "priority_encoder.v", "axis_fifo.v", "axis_async_fifo.v", "axis_async_fifo_adapter.v", "sync_reset.v", "arty_mii.v"]
        self.PINDEFAULTS = {
            "phy_rx_clk": {
                "direction": "input",
