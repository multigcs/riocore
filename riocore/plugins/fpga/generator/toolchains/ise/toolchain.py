...
class Toolchain:
    ...
    def info(cls):
        return {
            "_url": "https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/vivado-design-tools/archive-ise.html",
            "url": "https://www.amd.com/en/support/downloads/adaptive-socs-and-fpgas/legacy-ise/v2012_4---14_7.html",
            "info": "Xilinx/AMD ISE WebPACK - Full Installer for Linux",
            "description": """
```
# mkdir /tmp/ise-inst
# cd /tmp/ise-inst
...
""",
    ...
    def pll(self, clock_in, clock_out):
        result = subprocess.check_output(
            f"python3 {os.path.join(self.riocore_path, 'files', 'ise-pll.py')} -d 'spartan6' -f \"{os.path.join(self.gateware_path, 'pll.v')}\" -i {float(clock_in) / 1000000} -o {float(clock_out) / 1000000}",
            shell=True,
        )
    ...
    def generate(self, path):
        ...
        if sys.platform == "linux":
            ...
            if ngdbuild is None:
                print("WARNING: toolchain installation not found in PATH: ise (ngdbuild)")
...
<project xmlns="http://www.xilinx.com/XMLSchema" xmlns:xil_pn="http://www.xilinx.com/XMLSchema">
  ...
  <files>
    <file xil_pn:name="rio-modules.v" xil_pn:type="FILE_VERILOG">
  ...
  <properties>
    ...
    <property xil_pn:name="Device" xil_pn:value="{device}" xil_pn:valueState="default"/>
    ...
    <property xil_pn:name="Implementation Top" xil_pn:value="Module|rio" xil_pn:valueState="non-default"/>
    <property xil_pn:name="Implementation Top File" xil_pn:value="rio-modules.v" xil_pn:valueState="non-default"/>
    <property xil_pn:name="Implementation Top Instance Path" xil_pn:value="/rio" xil_pn:valueState="non-default"/>
    ...
    <property xil_pn:name="Output File Name" xil_pn:value="rio" xil_pn:valueState="default"/>
    <property xil_pn:name="Overwrite Compiled Libraries" xil_pn:value="false" xil_pn:valueState="default"/>
    <property xil_pn:name="Pack I/O Registers into IOBs" xil_pn:value="Auto" xil_pn:valueState="default"/>
    <property xil_pn:name="Pack I/O Registers/Latches into IOBs" xil_pn:value="Off" xil_pn:valueState="default"/>
    <property xil_pn:name="Package" xil_pn:value="{package}" xil_pn:valueState="default"/>
    ...
    <property xil_pn:name="Post Map Simulation Model Name" xil_pn:value="rio_map.v" xil_pn:valueState="default"/>
    <property xil_pn:name="Post Place &amp; Route Simulation Model Name" xil_pn:value="rio_timesim.v" xil_pn:valueState="default"/>
    <property xil_pn:name="Post Synthesis Simulation Model Name" xil_pn:value="rio_synthesis.v" xil_pn:valueState="default"/>
    <property xil_pn:name="Post Translate Simulation Model Name" xil_pn:value="rio_translate.v" xil_pn:valueState="default"/>
    ...
    <property xil_pn:name="Speed Grade" xil_pn:value="-{speed}" xil_pn:valueState="default"/>
    ...
    <property xil_pn:name="PROP_DesignName" xil_pn:value="rio" xil_pn:valueState="non-default"/>
    ...
    <property xil_pn:name="PROP_intProjectCreationTimestamp" xil_pn:value="2025-08-20T09:41:24" xil_pn:valueState="non-default"/>
    <property xil_pn:name="PROP_intWbtProjectID" xil_pn:value="A54BE5FDBB4D2F8144585E5FE74F929C" xil_pn:valueState="non-default"/>
