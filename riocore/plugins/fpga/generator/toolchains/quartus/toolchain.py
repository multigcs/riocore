...
class Toolchain:
    ...
    def info(cls):
        return {
            "url": "https://www.altera.com/downloads/fpga-development-tools/quartus-prime-lite-edition-design-software-version-17-0-linux",
            "info": "Intel Quartus - please check the version that supports your FPGA",
...
""",
    ...
    def generate(self, path):
        ...
        makefile_data.append("")
        makefile_data.append("build: prepare $(PROJECT)")
        makefile_data.append("")
        ...
        elif self.config["family"] in {"MAX II"}:
        ...
        makefile_data.append("prog: $(PROJECT).pof")
        makefile_data.append('	$(Q)$(ECHO) "Programming."')
        makefile_data.append('	$(QP) --no_banner --mode=jtag -o "P;$(PROJECT).pof"')
