...
class i2c_device:
    ...
    def __init__(self, parent, system_setup=None):
        ...
        self.PINDEFAULTS = {
            "I2C": {"direction": "output", "edge": "target", "pos": [20, 8], "type": ["I2C"], "bus": True},
            "I2C:OUT": {"direction": "output", "edge": "source", "pos": [36, 8], "type": ["PASSTHROUGH"], "bus": True, "pintype": "PASSTHROUGH", "source": "I2C"},
        }
