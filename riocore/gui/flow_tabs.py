...
class TabOptions:
    ...
    def load(self):
        ...
        for key, var_setup in {
            "machinetype": {"type": "select", "options": ["mill", "lathe", "corexy", "ldelta", "rdelta", "scara", "puma", "melfa", "melfa_nogl", "xyzac-trt-kins"], "help_text": "type of the machine"},
            "toolchange": {"type": "select", "options": ["manual", "auto"], "default": "manual", "help_text": "type of the toolchanger"},
            "gui": {
                "type": "select",
                "options": list(riocore.gui_dict),
                "default": "axis",
            ...
            "vcp_type": {"type": "select", "options": list(riocore.vcp_dict), "default": "auto", "help_text": "vcp type, depends on the gui"},
            ...
            "autoconnect": {"type": bool, "help_text": "autoconnect at startup (estop)", "default": False},
